...
class HuifuCFCA
{
    ...
    public function apiRequest(){
        ...
        $requestParam['mer_cust_id'] = '310000016002293818';
        $requestParam['user_cust_id'] = '6666000000054387';
        $requestParam['order_date'] = date('YmdHis');
        $requestParam['order_id'] = date('YmdHis', time()) . rand(1111, 9999);
        $requestParam['trans_amt'] = '0.01';
        $requestParam['cash_bind_card_id'] = '76247';
        $requestParam['fee_obj'] = '';
        $requestParam['fee_acct_id'] = '';
        $requestParam['cash_type'] = '02030000';
        $requestParam['bg_ret_url'] = 'http://testoapi.longde999.cn/asyncHandle.json';
